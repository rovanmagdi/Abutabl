    ...
    return (
        <Accordion allowMultipleExpanded>
            <AccordionItem>
                ...
                <AccordionItemPanel>
                    About lesson Here Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                    ...
                    <div className="detailsUnit">
                        ...
                        <div className='pb-5'>
                            ...
                            <div className="flex justify-between items-center pb-0.5 px-5 pr-5 mt-5 ">
                                ...
                                <div>3 min</div>
                            </div> <div className="flex justify-between items-center pb-0.5 px-5 pr-5  mt-5">
                                <div className="flex  items-center">
                                    <img src={Article} alt="Book" className="mr-2 color-#9C9B9B" />
                                    <div className="text-stone-400">Video: Get to know number 1 and sing along</div>
                                </div>
